"""
Generated MCP Tool: FastFlightsToolV4
...
def call_get_flights(flight_data: List[Dict], trip: str, seat: str, passengers: Dict[str, Any], fetch_mode: str = "common"):
    ...
    try:
        from fast_flights import FlightData, Passengers, Result, get_flights
                ...
                # Convert flight_data list to Item objects
        flight_data_objects = []
        for item in flight_data:
            flight_data_objects.append(Item(
                date=item['date'],
        ...
        response = {}
        response['flight_information'] = result.flight_information
        response['prices'] = result.prices
        response['availability'] = result.availability
        return response
...
class FastFlightsToolV4:
    ...
    def run(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": str(e),
                "message": f"Failed to execute FastFlightsToolV4: {str(e)}"
            }
